...
const Manager = ({isHost, baseUrl, langJson, roomUsers, handleKick}: ManagerProps) => {
    ...
    return (
        <main className={styles.main}>
            ...
            <ManageList isHost={isHost} langJson={langJson} roomUsers={roomUsers} setPlayerName={setPlayerName} setChosenId={setChosenId} handleKick={handleKick} />
        </main>
    );
};
